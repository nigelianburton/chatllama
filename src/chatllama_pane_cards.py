...
class CardsPanel(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._scroll_layout.addWidget(self._card_svg)
    ...
    def add_card(self, card: QtWidgets.QWidget, title: str = "") -> None:
        """Add a card widget to the cards panel."""
        try:
            if title:
            ...
            logger.info(f"Card added to CardsPanel: {title}")
